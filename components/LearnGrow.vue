<template>
  <div class="row uku-hero items-start justify-center">
    <div class="col-12 col-lg-12 col-md-12 col-sm-12 col-xs-12">
      ...
      <div class="uku-learn row items-start justify-center">
        <div class="col-8 col-lg-8 col-md-8 col-sm-12 col-xs-12 uku-learn-col">
          <div class="uku-learn-title">{{ title }}</div>
          <div class="uku-learn-subtitle">{{ subtitle }}</div>
          <div class="uku-learn-text">
        ...
        <div class="col-4 col-lg-4 col-md-4 col-sm-12 col-xs-12 uku-learn-col">
          <div class="uku-learn-title">{{ title }}</div>
          <div class="uku-learn-subtitle">{{ subtitle }}</div>
          <div class="uku-learn-text">
            Ukulima empowers African farmers by utilising Blockchain Technology to manage, finance and insure small-hold
...
export default {
  ...
  data() {
    return {
      title: 'Learn & Grow',
      subtitle: 'Learn from industry leaders and build meaningful relationships',
    }
  },
}
</script>
