<template>
  <div class="row uku-hero items-start justify-center">
    <div class="col-12 col-lg-12 col-md-12 col-sm-12 col-xs-12">
      ...
      <div class="uku-nfts-list row items-start justify-center">
        <div class="col-8 col-lg-8 col-md-8 col-sm-12 col-xs-12 uku-nfts-list-col">
          <div class="uku-nfts-title">{{ title }}</div>
          <div class="uku-nfts-subtitle">{{ subtitle }}</div>
          <div class="uku-nfts-text">
        ...
        <div class="col-4 col-lg-4 col-md-4 col-sm-12 col-xs-12 uku-nfts-list-col">
          <div class="uku-nfts-title">{{ title }}</div>
          <div class="uku-nfts-subtitle">{{ subtitle }}</div>
          <div class="uku-nfts-text">
            Ukulima empowers African farmers by utilising Blockchain Technology to manage, finance and insure small-hold farmers throughout Africa.
...
export default {
  ...
  data() {
    return {
      title: 'Land NFTs',
      subtitle: 'Create your Land NFTs and stake to earn additional interest & coverage',
    }
  },
}
</script>
