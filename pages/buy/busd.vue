<template>
  <q-layout view="hHh lpR fFf">
    <HeaderLogoWhite />
    <q-page-container class="binance-black-bg">
      <q-page>
          ...
          <div class="col-12 col-lg-12 col-md-12 col-sm-12 self-center" align="center">
            <div class="uku-buy">
              ...
              <div class="row items-center no-wrap">
                <div class="uku-buy-title">Purchase BUSD</div>
              </div>
              ...
              <div class="row no-wrap items-center justify-center" align="center">
                <q-form ref="buyForm" class="q-gutter-md uku-form" autocomplete="off" @submit="buyNow" @reset="resetForm">
                  ...
                  <div class="self-center full-width no-outline">
                    <q-btn outline rounded class="uku-buy-button" label="Buy BUSD Now" type="submit" tabindex="4" />
                  </div>
                  <div class="self-center full-width no-outline">
              ...
              <div class="row items-center justify-center no-wrap">
                <div class="uku-footer-text">
                  Need more AGRI Tokens?
                  <nuxt-link to="/buy/agri" class="uku-footer-link">Buy AGRI Tokens ›</nuxt-link>
                </div>
              </div>
            </div>
          </div>
...
/* Components */
import HeaderLogoWhite from '../../components/general/HeaderLogoWhite.vue'
import FooterWhite from '../../components/general/FooterWhite.vue'
/* LFG */
export default {
  name: 'BuyBUSD',
  components: {
